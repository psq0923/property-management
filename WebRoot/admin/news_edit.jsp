		...
		<div id="usual1" class="usual">
			...
			<div id="tab1" class="tabson">
				...
				<form action="updateNews.action" method="post">
					...
					<textarea id="content7" name="news.content" value='<s:property value="news.content"/>' style="width:700px;height:400px;visibility:hidden;">
						<s:property value="news.content"/>
					</textarea>
					</li>
					<li><label>新闻标题<b>*</b></label>
					<input type="hidden" name="news.id" value='<s:property value="news.id"/>'/>
					<input name="news.title" type="text" class="dfinput" value='<s:property value="news.title"/>' style="width:300px;" /></li>
					<li><label>状态<b>*</b></label><cite>
						<s:if test="news.is_show==0">
						<input type="radio" name="news.is_show" value="0" checked/>显示
						<input type="radio" name="news.is_show" value="1"/>隐藏
						</s:if>
						<s:else>
							<input type="radio" name="news.is_show" value="0"/>是
							<input type="radio" name="news.is_show" value="1" checked/>否
						</s:else>
					</cite></li>
